...
public class RFCoilXferAugmentItemBuilder extends ItemBuilder {
    private Rarity rarity = Rarity.EPIC;
    private float energyStorage;
    private float energyXfer;
    public RFCoilXferAugmentItemBuilder(ResourceLocation i) {
        super(i);
    }
    public RFCoilXferAugmentItemBuilder setRarityById(String rarityName, int chatFormattingId){
        this.rarity = Rarity.create(rarityName, ChatFormatting.getById(chatFormattingId));
        return this;
    }

    public RFCoilXferAugmentItemBuilder setValue(float energyStorage, float energyXfer){
